    ...
    return (
      <div className="progress-group">
        <div className="progress-group-header">
          ...
          <span className="ml-auto font-weight-bold">{this.props.shard.current} <span className="text-muted small">({((this.props.shard.current / this.props.shard.capacity) * 100).toPrecision(3)}%)</span></span>
        </div>
