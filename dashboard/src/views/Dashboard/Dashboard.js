                    ...
                    <Row>
                      <Col sm="6">
                        <div className="callout callout-info">
                          <small className="text-muted">Connected Players (Global)</small>
                          <br />
                      ...
                      <Col sm="6">
                        <div className="callout callout-danger">
                          <small className="text-muted">Players - The Void</small>
                          <br />
                    ...
                    <Row>
                      <Col sm="6">
                        <div className="callout callout-warning">
                          <small className="text-muted">Players - Main Lobby</small>
                          <br />
                      ...
                      <Col sm="6">
                        <div className="callout callout-success">
                          <small className="text-muted">Players - KubeCon 2019</small>
                          <br />
